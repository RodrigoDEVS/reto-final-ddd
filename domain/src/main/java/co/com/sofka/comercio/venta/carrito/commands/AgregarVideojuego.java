...
public class AgregarVideojuego extends Command {
    ...
    public AgregarVideojuego(VideojuegoId videojuegoId, Nombre nombre, Sistema sistema, Formato formato, Valor valor, CarritoId carritoId) {
