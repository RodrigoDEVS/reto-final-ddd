...
public class AgregarConsola extends Command {
    ...
    public AgregarConsola(ConsolaId consolaId, Sistema sistema, Tipo tipo, Modelo modelo, Valor valor, CarritoId carritoId) {
